public class BonbonStandard{
    ...
    public BonbonStandard(){
        typeBonbons[0] = new Bonbons(1,"\u001B[31m\u00A4\u001B[0m",false,0);
        typeBonbons[1] = new Bonbons(2,"\u001B[32m\u01A2\u001B[0m",false,0);
        typeBonbons[2] = new Bonbons(3,"\u001B[33m\u0277\u001B[0m",false,0);
        typeBonbons[3] = new Bonbons(4,"\u001B[36m\u047A\u001B[0m",false,0);
    }
