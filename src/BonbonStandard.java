...
public class BonbonStandard{
	...
	public BonbonStandard(){
		typeBonbons[0] = new Bonbons(1,"\u00A4",false,20);
		typeBonbons[1] = new Bonbons(2,"\u01A2",false,20);
		typeBonbons[2] = new Bonbons(3,"\u0277",false,20);
		typeBonbons[3] = new Bonbons(4,"\u047A",false,20);
	}
